(function (d) {
    ...
    var b = {majorVersion: "3", minorVersion: "4.7", releaseDate: "2011-11-03", _init: function () {
...
(function (a) {
    a.VK = {DELETE: 46, BACKSPACE: 8, ENTER: 13, TAB: 9, SPACEBAR: 32, UP: 38, DOWN: 40}
})(tinymce);
(function (k) {
    var i = k.VK, j = i.BACKSPACE, h = i.DELETE;

    function c(m) {
        var o = m.dom, n = m.selection;
        m.onKeyDown.add(function (q, u) {
            ...
            if (r || u.keyCode == j) {
                ...
                v = o.getParent(p.startContainer, o.isBlock);
                k.each(o.select("span.Apple-style-span,font.Apple-style-span", v), function (x) {
                    var y = n.getBookmark();
                    if (t) {
    ...
    function e(m) {
        m.onKeyDown.add(function (n, q) {
            if (q.keyCode === j) {
                if (n.selection.isCollapsed() && n.selection.getRng(true).startOffset === 0) {
    ...
    function f(m) {
        m.onClick.add(function (n, o) {
            ...
            if (/^(IMG|HR)$/.test(o.nodeName)) {
                n.selection.getSel().setBaseAndExtent(o, 0, o, 1)
            }
    ...
    k.create("tinymce.util.Quirks", {Quirks: function (m) {
        if (k.isWebKit) {
            c(m);
            d(m);
            b(m);
...
(function (a) {
    a.Formatter = function (U) {
        var M = {}, O = a.each, c = U.dom, q = U.selection, t = a.dom.TreeWalker, K = new a.dom.RangeUtils(c), d = U.schema.isValidChild, F = c.isBlock, l = U.settings.forced_root_block, s = c.nodeIndex, E = "\uFEFF", e = /^(src|href|style)$/, R = false, B = true, p;
        ...
        function S(Y, ag, ab) {
            var ac = Q(Y), ah = ac[0], af, W, ae, ad = q.isCollapsed();

            function Z(al) {
                var ak = al.startContainer, ao = al.startOffset, an, am;
            ...
            function ai(al, an, ap) {
                ...
                K.walk(al, function (aq) {
                    ...
                    function at(au) {
                        ...
                        if (d(ao, ax) && d(aw, ao) && !(!ap && au.nodeType === 3 && au.nodeValue.length === 1 && au.nodeValue.charCodeAt(0) === 65279) && au.id !== "_mce_caret") {
                            if (!ar) {
                                ar = am.cloneNode(R);
        ...
        function A(X, ag, aa) {
            ...
            function aj(ak) {
                ...
                K.walk(ak, function (an) {
                    O(an, function (ao) {
                        Y(ao);
                        if (ao.nodeType === 1 && U.dom.getStyle(ao, "text-decoration") === "underline" && ao.parentNode && i(ao.parentNode) === "underline") {
                            T({deep: false, exact: true, inline: "span", styles: {textDecoration: "underline"}}, null, ao)
                        }
                    })
                })
            }
                ...
                if (ae) {
                    if (ae.length === p) {
                        ...
                        for (af = 0; af < ae.length; af++) {
                            if (ak === "attributes" ? c.getAttrib(ah, ae[af]) : L(ah, ae[af])) {
                                return aj
                            }
                        }
                    }
        ...
        function o(V, ah, Y) {
            var X = V.startContainer, ac = V.startOffset, ak = V.endContainer, ae = V.endOffset, aj, ag, ab, af;
            ...
            if (ah[0].inline) {
                ...
                if (ab.node) {
                    ...
                    if (ab.node && ab.offset > 0 && ab.node.nodeType === 3 && ab.node.nodeValue.charAt(ab.offset - 1) === " ") {
                        if (ab.offset > 1) {
                            ak = ab.node;
            ...
            return{startContainer: X, startOffset: ac, endContainer: ak, endOffset: ae}
        }
        ...
        function P(ae, V, ac) {
            var ah, af = "_mce_caret", W = U.settings.caret_debug;
            ah = a.isGecko ? "\u200B" : E;
            function X(aj) {
                var ai = c.create("span", {id: af, "data-mce-bogus": true, style: W ? "color:red" : ""});
                if (aj) {
            ...
            function ad(aj, ai) {
                while (aj) {
                    if ((aj.nodeType === 3 && aj.nodeValue !== ah) || aj.childNodes.length > 1) {
                        return false
                    }
                    if (ai && aj.nodeType === 1) {
                        ai.push(aj)
            ...
            function ab() {
                ...
                if (am && an > 0 && an < am.length && /\w/.test(am.charAt(an)) && /\w/.test(am.charAt(an - 1))) {
                    al = q.getBookmark();
                    ak.collapse(true);
                    ak = o(ak, Q(V));
                    ak = K.split(ak);
            ...
            function ag() {
                var ai = q.getRng(true), aj, al, ao, an, ak, ar, aq = [], am, ap;
